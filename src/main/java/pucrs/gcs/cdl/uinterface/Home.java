...
public class Home implements Initializable {
	...
	public void registrarEntrada(ActionEvent e) {
		try {
			Parent s = FXMLLoader.load(getClass().getClassLoader().getResource("RegistrarEntrada.fxml"));
	...
	public void registrarSaida(ActionEvent e) {
		try {
			Parent s = FXMLLoader.load(getClass().getClassLoader().getResource("RegistrarSaida.fxml"));
